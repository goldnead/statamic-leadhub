 ...
 * strings of its own, so the same file works in every addon of the suite — and
 * so all nine LeadHub listings share this one component rather than nine
 * near-identical empty states.
 */
