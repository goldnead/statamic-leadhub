...
/**
 * Answers "who does brand N send as, and over which mailer", for statamic-leadhub.
 *
 * The rule itself lives in `goldnead/statamic-brand-context` since 1.8.0 — see
 * {@see BrandSenderIdentityResolver} for the contract, its two ways of saying
 * "I cannot answer", and why neither of them is an exception.
 *
 * **This sub-interface stays, and it is not ceremony.** A host with several of
 * these addons installed may want internal staff post resolved differently from
 * marketing post to customers, and one shared binding cannot express that.
 * Binding this interface changes the answer for statamic-leadhub alone:
 *
